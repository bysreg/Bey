...
void D3DRendering::Init(const RenderingInitData* data)
{
	...
	swapChainDesc.BufferDesc.RefreshRate.Numerator = 60; // 60/1 heartz refresh rate
	...
	swapChainDesc.SampleDesc.Count = 1; // for now we dont use multisampling
	...
	depthStencilDesc.SampleDesc.Count = swapChainDesc.SampleDesc.Count; // must match swap chain MSAA values
